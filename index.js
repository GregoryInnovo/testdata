 ...
 * /usuarios/completos:
 *   get:
 *     summary: Obtener todos los usuarios con información completa
 *     tags: [Usuarios]
 *     responses:
 *       200:
 *         description: Lista de todos los usuarios con sus citas
 *         content:
 *           application/json:
 *             example:
 *               - id: "fb4219e3-d141-4475-a3c3-6a9e94e2b133"
 ...
 *                 numero_documento: "1020304050"
 *                 telefono: "3001234567"
 *                 created_at: "2023-07-15T10:20:30Z"
 *                 updated_at: "2023-07-15T10:20:30Z"
 *                 citas:
 *                   - id: "a9b9c9d9-e9f9-49a9-b9c9-d9e9f9a9b9c9"
 *                     dia: "2023-08-15T14:00:00Z"
 *                     duracion: 60
 ...
 *                       id: "145310bb-f764-4d21-be4a-95a619d3a3d2"
 *                       nombre: "Corte de cabello"
 *                   - id: "c9d9e9f9-a9b9-c9d9-e9f9-a9b9c9d9e9f9"
 *                     dia: "2023-09-05T11:30:00Z"
 *                     duracion: 30
 *                     estado: "pendiente"
 *                     servicio:
 *                       id: "145310bb-f764-4d21-be4a-95a619d3a3d2"
 ...
 *                 numero_documento: "1098765432"
 *                 telefono: "3109876543"
 *                 created_at: "2023-07-20T14:25:10Z"
 *                 updated_at: "2023-07-20T14:25:10Z"
 *                 citas:
 *                   - id: "b8c7d6e5-f4g3-h2i1-j0k9-l8m7n6o5p4q3"
 *                     dia: "2023-08-16T10:30:00Z"
 *                     duracion: 45
 ...
 *                       nombre: "Manicure"
 */
app.get("/usuarios/completos", async (req, res) => {
  try {
    // Obtener todos los usuarios con sus citas
    const { data, error } = await supabase.from("usuarios").select(`
        *,
        citas:citas(id, dia, duracion, estado, servicio:tipo_servicio(id, nombre))
      `);
